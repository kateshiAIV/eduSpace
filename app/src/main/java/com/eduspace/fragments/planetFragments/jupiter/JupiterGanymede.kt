package com.eduspace.fragments.planetFragments.jupiter
...
private val planets = listOf("SolarSys","Sun","Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune","Ganymede")

class JupiterGanymede : Fragment() {
    ...
    private var currentPlanetIndex =10
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_jupiter_ganymede, container, false)
