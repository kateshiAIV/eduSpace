...
private val planets = listOf("SolarSys","Sun","Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune","Moon","Phobos", "Deimos")

class MarsDeimos : Fragment() {
    private lateinit var drawerLayout: DrawerLayout
    private lateinit var navigationView: NavigationView
    private lateinit var toggle: ActionBarDrawerToggle

    private var currentPlanetIndex =12
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_mars_deimos, container, false)
