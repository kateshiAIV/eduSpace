package com.eduspace.fragments.planetFragments.saturn
...
private val planets = listOf("SolarSys","Sun","Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune","Enceladus")

class SaturnEnceladus : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_saturn_enceladus, container, false)
