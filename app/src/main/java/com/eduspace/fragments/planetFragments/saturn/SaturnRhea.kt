...
private val planets = listOf("SolarSys","Sun","Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune","Rhea")

class SaturnRhea : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_saturn_rhea, container, false)
